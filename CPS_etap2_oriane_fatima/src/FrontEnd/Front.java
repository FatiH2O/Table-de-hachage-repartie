...
public class Front extends AbstractComponent{
	...
	protected Front(DHTServices_Simple_endpoint Client_Front_edp,AccessSync_edp  Front_to_Access_edp) throws ConnectionException {
		super(1, 0);
...
@Override
	...
	public ContentDataI get(ContentKeyI key) throws Exception {
		...
		return this.Front_to_Access_edp.getClientSideReference().getSync(STANDARD_REQUEST_HANDLER_URI, key);
	}

	
	public ContentDataI put(ContentKeyI key, ContentDataI value) throws Exception {
		
		return this.Front_to_Access_edp.getClientSideReference().putSync(STANDARD_REQUEST_HANDLER_URI, key, value);
	}

	
	public ContentDataI remove(ContentKeyI key) throws Exception {
		
		return this.Front_to_Access_edp.getClientSideReference().removeSync(STANDARD_REQUEST_HANDLER_URI, key);
	}
