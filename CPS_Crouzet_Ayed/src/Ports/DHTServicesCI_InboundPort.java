...
public class DHTServicesCI_InboundPort extends AbstractInboundPort implements DHTServicesCI {
	...
	public DHTServicesCI_InboundPort(ComponentI owner, String uri) throws Exception {
	...
	public <R extends Serializable, A extends Serializable> A mapReduce(SelectorI selector, ProcessorI<R> processor,
		...
		return this.getOwner().handleRequest(
				owner -> ((Front) owner).mapReduceAsync(selector, processor, reductor, combinator, initialAcc));
