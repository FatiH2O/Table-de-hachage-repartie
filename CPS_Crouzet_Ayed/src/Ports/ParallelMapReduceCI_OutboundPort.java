...
public class ParallelMapReduceCI_OutboundPort extends MapCI_OutboundPort implements ParallelMapReduceCI{

	private static final long serialVersionUID = 1L;

	public ParallelMapReduceCI_OutboundPort(String uri, ComponentI owner) throws Exception {
		super(uri, owner);
			}
