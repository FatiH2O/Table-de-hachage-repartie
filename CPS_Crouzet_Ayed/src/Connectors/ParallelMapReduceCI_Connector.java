...
public class ParallelMapReduceCI_Connector extends AbstractConnector implements ParallelMapReduceCI {
	...
	public <A extends Serializable, R, I extends MapReduceResultReceptionCI> void reduce(String computationURI,
		...
		((ParallelMapReduceCI)this.offering).reduce(computationURI, reductor, combinator,
				identityAcc,currentAcc,callerNode);
	...
	public <R extends Serializable> void mapSync(String computationURI, SelectorI selector, ProcessorI<R> processor)
			throws Exception {
		((ParallelMapReduceCI)this.offering).mapSync(computationURI, selector, processor);
	...
	public <A extends Serializable, R> A reduceSync(String computationURI, ReductorI<A, R> reductor,
		...
		return	((ParallelMapReduceCI)this.offering).reduceSync(computationURI, reductor,
				combinator,currentAcc);
	}
	...
	public <R extends Serializable> void parallelMap(String computationURI, SelectorI selector, ProcessorI<R> processor,
		...
		((ParallelMapReduceCI)this.offering).parallelMap(computationURI, selector, processor,
				parallelismPolicy);		
	}
	...
	public <A extends Serializable, R, I extends MapReduceResultReceptionCI> void parallelReduce(String computationURI,
		...
		((ParallelMapReduceCI)this.offering).parallelReduce(computationURI, reductor, combinator,
				identityAcc,currentAcc,parallelismPolicy,caller);		
	}
